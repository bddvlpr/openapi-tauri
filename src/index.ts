...
interface ClientOptions
  extends Omit<TauriRequestOptions, "headers" | "method"> {
...
export default function createClient<Paths extends {}>(
  ...
  type GetFetchOptions<P extends GetPaths> = MethodlessFetchOptions<
    FilterKeys<Paths[P], "get">
  >;
  type PutFetchOptions<P extends PutPaths> = MethodlessFetchOptions<
    FilterKeys<Paths[P], "put">
  >;
  type PostFetchOptions<P extends PostPaths> = MethodlessFetchOptions<
  ...
  >;
  type HeadFetchOptions<P extends HeadPaths> = MethodlessFetchOptions<
